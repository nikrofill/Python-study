...
a = int(input("В какое время я не смогу получить посылку: "))
b = int(input("В какое время приехала машины: "))
c = b + 1
if(a <= 22 and a >= 8):
    if(a == 14 or a == 15):
        print("В это время обед")
    elif(a == b or a == c):
        print("Идет разгрузка, не получится")
    else:
        print("Все ок, все работает") 
else:
    print("Работаем с 08 до 23")
